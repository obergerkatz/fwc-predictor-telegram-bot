...
CREATE TABLE IF NOT EXISTS group_stage_predictions (
    id SERIAL PRIMARY KEY,
    user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    
    -- Group A qualifiers
    group_a_first VARCHAR(100) NOT NULL,
    group_a_second VARCHAR(100) NOT NULL,
    
    -- Group B qualifiers
    group_b_first VARCHAR(100) NOT NULL,
    group_b_second VARCHAR(100) NOT NULL,
    
    -- Group C qualifiers
    group_c_first VARCHAR(100) NOT NULL,
    group_c_second VARCHAR(100) NOT NULL,
    
    -- Group D qualifiers
    group_d_first VARCHAR(100) NOT NULL,
    group_d_second VARCHAR(100) NOT NULL,
...
-- Update leaderboard view to include group stage bonus points
